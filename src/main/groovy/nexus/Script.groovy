 ...
 * <a href="https://github.com/sonatype/nexus-book-examples/blob/nexus-3.x/scripting/complex-script/addUpdateScript.groovy">
...
CliBuilder cli = new CliBuilder(
        usage: 'java -jar nexus-addscript-all.jar -u admin -p admin123 -f scriptFile.groovy [-n explicitName] [-h nx3Url]')
cli.with {
